...
export async function createGateway(): Promise<ScriptedModelGateway> {
...
export async function createHarness(
  ...
  retention: 'none' | 'hash-only' | 'encrypted-payload' = 'encrypted-payload',
): Promise<Harness> {
  ...
  return { client, composition, gateway };
}
