...
export const EVIDENCE_OBSERVE_ARTIFACT_CONTRACT_VERSION_V10 = '1.9.0' as const;
export const EVIDENCE_OBSERVE_ARTIFACT_CONTRACT_VERSION_V11 = '1.10.0' as const;
export const EVIDENCE_OBSERVE_ARTIFACT_CONTRACT_VERSION = '1.11.0' as const;
export const EVIDENCE_RELATE_OBSERVATIONS_CONTRACT_VERSION_V2 =
  '1.1.0' as const;
export const EVIDENCE_RELATE_OBSERVATIONS_CONTRACT_VERSION = '1.2.0' as const;
...
export const EvidenceTaskCatalogueEntrySchema = z
  .object({
    ...
    version: z.enum([
      ...
      EVIDENCE_OBSERVE_ARTIFACT_CONTRACT_VERSION_V10,
      EVIDENCE_OBSERVE_ARTIFACT_CONTRACT_VERSION_V11,
...
export const EVIDENCE_OBSERVE_ARTIFACT_CONTRACT_REF_V10 = immutableEvidence({
  id: EVIDENCE_OBSERVE_ARTIFACT_TASK,
  version: EVIDENCE_OBSERVE_ARTIFACT_CONTRACT_VERSION_V10,
});

export const EVIDENCE_OBSERVE_ARTIFACT_CONTRACT_REF_V11 = immutableEvidence({
  id: EVIDENCE_OBSERVE_ARTIFACT_TASK,
  version: EVIDENCE_OBSERVE_ARTIFACT_CONTRACT_VERSION_V11,
});
...
export const EVIDENCE_RELATE_OBSERVATIONS_CONTRACT_REF_V2 = immutableEvidence({
  id: EVIDENCE_RELATE_OBSERVATIONS_TASK,
  version: EVIDENCE_RELATE_OBSERVATIONS_CONTRACT_VERSION_V2,
});
