...
Current checkpoint: ACME-0116 single-line observation candidates. Stages 1–8 are
...
500-character quote bounds and the full-date temporal `unknown` rule. Another
separately frozen acceptance remains.
