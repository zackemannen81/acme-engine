...
| Proposal | Status |
| --- | --- |
| [`domain-test-ui-implementation.md`](domain-test-ui-implementation.md) | Core phases 0–6 and S1–S7 browser flow delivered through ACME-0050; residual surfaces and multi-step live remain optional |
