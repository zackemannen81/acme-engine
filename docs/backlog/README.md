...
| Proposal | Status |
| --- | --- |
| [`domain-test-ui-implementation.md`](domain-test-ui-implementation.md) | Core phases 0–6 and S1–S6 browser flow delivered through ACME-0049; residual surfaces and multi-step live remain optional |
