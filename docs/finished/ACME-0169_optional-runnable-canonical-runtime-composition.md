...
- [x] `pnpm lint`
- [x] `pnpm typecheck`
- [x] package-boundary gate
- [x] unit suite
- [x] conformance suite
- [x] integration suite including focused runtime-service tests
- [x] deterministic scenario suite
- [x] build
...
- [x] Run and repair full canonical CI without expanding scope.
- [x] Synchronize long-lived documentation and archive task.
- [x] Run final docs-inclusive canonical CI and hand off to Rickard.
...
- Final post-format canonical CI run `32245847498` passed at head `7f561b1332de43bb63f78a6cbed0b639522d3473`.
...
- [x] No ADR update required; composition implements ADR-0051 without changing it.

## Handoff and Follow-ups

- Current state: Complete; PR #38 is approved, merged and green, with no protected-path changes.
- Next recommended step: activate Connectors or domain-translation documentation only as a separately claimed and frozen task.
- Blockers: None.
- Child tasks: None.
