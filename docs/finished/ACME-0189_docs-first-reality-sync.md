...
Replacement: `docs/CURRENT_TASK.md` (ACME-0190, Draft)
...
Reconcile ACME's current public and governing documentation with merged repository and published package reality through ACME-0188. Historical records remain historical; this task repairs current truth surfaces only.

## Supersession

The task's frozen goal is a documentation-only reality sync. The newly discovered
provider-boundary defect is a behavioral change to strict structured-output
schema lowering, with its own compatibility, losslessness and regression-proof
requirements. It cannot honestly be added to this charter. It is therefore
superseded, without completing the documentation-sync Definition of Done, by
ACME-0190.
...
- No product/runtime source files change.
...
- [x] Supersede because provider schema-lowering behavior is outside the frozen charter.
- [x] Archive and hand off to ACME-0190.
...
- Publication history is preserved; current release state is added where needed.
...
- Not run: the frozen docs-only deliverable was not completed.
...
- Current state: superseded before the documentation audit and repairs were completed.
- Next recommended step: carry the uncompleted documentation sync only in a separately chartered task if still wanted.
- Blockers: none.
- Child tasks: none.
- Resume condition: explicit activation of a new documentation-only task.
- Open questions: none.
