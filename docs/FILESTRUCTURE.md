...
- `@acme/test-ui`: the Domain Test UI (ADR-0019 to ADR-0024). Phases 1–6 are
  view contracts for S1–S10; ACME-0045–0048 add pure HTML renderers
  (`src/web/`) and a loopback workbench serve on `./local` for S1–S5 (other
...
and delivered phases 0 and 1; ACME-0040 through ACME-0048 added phases 2–6,
the loopback HTML workbench, protected offline plan preview/launch and catalog
rendering for S1–S5 under ADR-0020 through ADR-0024. Remaining HTML surfaces and
