...
- [`docs/finished/ACME-0042_domain-test-ui-launch-and-history.md`](finished/ACME-0042_domain-test-ui-launch-and-history.md)
...
- [ ] Write the ADR for measurement and fixture approval.
- [ ] Add the measurement contract and its pure builder.
- [ ] Add the fixture review contract, proposals and approval records.
- [ ] Extend the workspace with baselines and approvals.
- [ ] Write the package tests, covering every refusal and unavailable case.
- [ ] Write an end-to-end test measuring real recorded runs.
- [ ] Run every minimum verification gate.
- [ ] Update `CURRENT_STATUS.md`, `SYSTEMDOC.md`, `FILESTRUCTURE.md`, the
      design specification and the backlog proposal.
- [ ] Add the signed `JOURNAL.md` entry and archive this task.
...
- [ ] `pnpm build`
- [ ] `git diff --check`
- [ ] No live provider call and no network access in any gate.
